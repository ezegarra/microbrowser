...
public class DatabaseDataSource {
    ...
    private ResultSet executeQuery(String query) throws SQLException {
        ...
        System.out.println("External query processing completed: "
                + (time/1000) + "." + (time%1000) + " seconds.");
        return rset;
    }
        ...
        throws DataIOException
    {
            ...
            if ( t == null ) {
                ...
                if ( key != null ) {
                    try {
                        ...
                        System.out.println("Indexed field: "+key);
                    } catch ( Exception e ) {
                        //s_logger.warning("Error indexing field: "+key);
                        System.out.println("Error indexing field: "+key);
                    }
                }
            }
        ...
        long time = System.currentTimeMillis()-timein;
       // s_logger.info
        System.out.println("Internal query processing completed: "+count+" rows, "
                + (time/1000) + "." + (time%1000) + " seconds.");
